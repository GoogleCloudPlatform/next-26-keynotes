# -------------------------------------------------------------------
# Environment: demo – Step 2 (Download Model)
# -------------------------------------------------------------------
# Same infra as step1, but enables the app module so the K8s model
# download job can run. Requires -var="hf_token=hf_xxx" at apply time.
# -------------------------------------------------------------------
...
# App Configuration – Gemini API only, no vLLM yet
app_version         = "v1.10"
